...
namespace EventBehaviorEditor
{

	[CustomEditor(typeof(MonoBehaviourListener))]
	public class MonobehaviourListenerEditor : Editor
	{
		...
		//MonoBehaviourInvoker asset
		//{
		//	get { return (MonoBehaviourInvoker)target; }
		//}
		...
		protected virtual void OnEnable()
		{
			...
			string[] eventNames = Enum.GetNames(typeof(MonoBehaviourListener.MonoEventType));
